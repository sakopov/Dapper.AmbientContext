...
namespace Dapper.AmbientContext.Tests
{
    ...
    {
        [Subject("Rollback DB Context Scope")]
        public class When_rolling_back_child_database_context_scope
        {
            Establish context = () =>
            {
            ...
            Because of = () =>
            {
                ChildDbContextScope.Rollback();
            };

            It should_not_rollback_and_dispose_its_parent_database_transaction = () =>
            {
        ...
        [Subject("Rollback DB Context Scope")]
        public class When_rolling_back_parent_database_context_scope
        {
            Establish context = () =>
            {
                var dbConnectionState = ConnectionState.Closed;
        ...
        [Subject("Rollback DB Context Scope")]
        public class When_rolling_back_parent_database_context_scope_fails
        {
            Establish context = () =>
            {
                var dbConnectionState = ConnectionState.Closed;
                ...
                DbTransactionMock = new Mock<IDbTransaction>();
                DbTransactionMock.Setup(mock => mock.Rollback()).Throws<Exception>();
                DbTransactionMock.Setup(mock => mock.Dispose()).Verifiable();
            ...
            Because of = () =>
            {
                Exception = Catch.Exception(() => ParentDbContextScope.Rollback());
            };
